...
| Проект | Описание |
|--------|----------|
| **Intent-Garden** | Детерминированный движок верификации C/C++ кода |
| **Rule-Rom** | Глобальная библиотека намерений |
| **LibWUI** | Высокопроизводительные инструменты для промышленного C++ |
