...
> *💭 Это не обещания, а ориентиры. Приоритеты могут меняться в зависимости от сообщества и ресурсов.*
...
| Ресурс | Описание |
| ------ | -------- |
| Контракт v0.2 | decima.rulerom.com/ru/CONTRACT |
| Эмулятор (GitHub) | github.com/rulerom/decima8 |
| Bakery (справочник) | bakery.rulerom.com |
| PKI-центр | pki.rulerom.com |
| libwui (UI-движок) | libwui.org |
...
> *💭 Если вам ближе подход «от физики, а не от маркетинга» — добро пожаловать.*
