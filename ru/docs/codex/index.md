...
> *💭 Decima-8 — инфраструктурный проект. Мы не продаём подписку на софт, мы строим экосистему.*
...
| Что | Зачем | Где |
| --- | ----- | --- |
| Спецификация машины | Исчерпывающий контракт для бинарной совместимости Emulator - FPGA - ASIC | [CONTRACT_v02](CONTRACT/index.md) |
| Исходный код референсного эмулятора, Verilog спецификации | Интеграции в конкретные ПАК, Верификация | [GitHub](https://github.com/rulerom/decima8) |
| IDE для визуальной выпечки | Ручное и полуавтоматическое пропекание нервной ткани личности, визуальный контроль и оперативное корректирование личности изготовленной любым путём | [IDE](../tools/ide/index.md) |
...
| Совет сварма | Сообщество. Реализовать такой проект без полноценного сообщества невозможно. | https://intent-garden.org/swarm.html |
