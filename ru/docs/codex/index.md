> **Архив v0.2.** Кодекс фиксирует ранний этап проекта. Для текущей физики v3 начните с [главной](../index.md): данные приходят всем ACTIVE-тайлам по общей VSB, а соседние рёбра передают только разрешение вычисления.
