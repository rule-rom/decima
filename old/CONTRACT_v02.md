...
- W[8][8] — SignedWeight5 (mag4+sign1)
...
- locked_after := 1
- thr_cur16 не меняется (latched), веса/decay не применяются
...
- 32 bytes: magnitudes Wmag[8][8] (64 nibble)
